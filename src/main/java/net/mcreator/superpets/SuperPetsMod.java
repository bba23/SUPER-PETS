...
import net.mcreator.superpets.friendship.FriendshipRelicsEvents;
...
public class SuperPetsMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(SuperPetsMod.class);
	public static final String MODID = "super_pets";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		FriendshipRelicsRegistry.load();
		// End of user code block mod constructor
		LOGGER.info("Initializing SuperPetsMod");
		SuperPetsModTabs.load();
		SuperPetsModBlocks.load();
		SuperPetsModItems.load();
		tick();
		// Start of user code block mod init
		FriendshipRelicsEvents.load();
